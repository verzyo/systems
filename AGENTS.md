...
2. `jj st` shows a clean, tracked state with a properly formatted commit message.
3. User-facing summary includes exactly what changed and what was validated.